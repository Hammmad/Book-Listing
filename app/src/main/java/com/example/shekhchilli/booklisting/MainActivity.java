...
public class MainActivity extends AppCompatActivity {
    ...
    EditText book;
    private static String apiurl = "https://www.googleapis.com/books/v1/volumes?q=search+terms";
    ;
    ...
    private class API extends AsyncTask<String, Void ,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            // Convert Stream into String us String builder
        ...
        @Override
        protected void onPostExecute(String FromStream) {
